...
public final class FragmentWebviewBinding implements ViewBinding {
  ...
  private FragmentWebviewBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView,
      @NonNull ConstraintLayout webview) {
  ...
  public static FragmentWebviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout webview = (ConstraintLayout) rootView;

      return new FragmentWebviewBinding((ConstraintLayout) rootView, textView, webview);
    }
