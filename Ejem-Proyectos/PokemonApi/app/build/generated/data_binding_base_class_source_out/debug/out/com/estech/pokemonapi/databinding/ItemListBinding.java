...
public final class ItemListBinding implements ViewBinding {
  ...
  private ItemListBinding(@NonNull ConstraintLayout rootView, @NonNull View divider,
      @NonNull ImageView ivImage, @NonNull ConstraintLayout llItem, @NonNull TextView tvName,
  ...
  public static ItemListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout llItem = (ConstraintLayout) rootView;
      ...
      return new ItemListBinding((ConstraintLayout) rootView, divider, ivImage, llItem, tvName,
          tvType);
    }
